...
export async function fetchRelevantReservations({ token, fetchImpl = fetch, now = Date.now() }) {
  if (reservationCache && reservationCache.expiresAt > now) return reservationCache.value;
